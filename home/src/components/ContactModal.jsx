...
const COPY = {
  es: {
    ...
    service: "Servicio",
    services: ["Diseño Web", "Interfaces Interactivas", "Videotutoriales", "E-learning", "Otro"],
    message: "Mensaje",
  ...
  en: {
    ...
    email: "Email address",
    service: "Service",
    services: ["Web Design", "Interactive Interfaces", "Video Tutorials", "E-learning", "Other"],
    message: "Message",
